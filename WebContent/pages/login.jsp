...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <div class="fadeIn first">
    	<img src="https://upload.wikimedia.org/wikipedia/commons/a/a3/Logo_Universit%C3%A9_Paris-Nanterre.svg" id="icon" alt="User Icon" />
			...
			<html:form action="/CheckLogin">
				...
				<table>
					...
					<tr class="fadeIn second">
						...
						<td align="center"><html:text property="firstName" size="150"
								maxlength="30" value="root" /></td>
					</tr>
					<tr class="fadeIn third">
						<!-- <td align="right"><bean:message key="form.password"/></td>-->
						<td align="center"><html:text property="lastName" size="150"
								maxlength="30" value="root" /></td>
					</tr>

					<tr class="fadeIn fourth">
						<td align="center"><html:submit><bean:message key="form.validate"/></html:submit></td>
					</tr>
    ...
    <!-- Remind Passowrd -->
    <div id="formFooter">
      <a class="underlineHover" href="#"><bean:message key="form.title"/></a>
    </div>
